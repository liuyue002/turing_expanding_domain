...
function schnackenburg_2dfunc(growthrate)
%% options
makegif=1;
showanimation=1;
drawperframe=500;
...
prefix = strcat('schnackenburg_2d_noisy_narrow_hssinit_' , datestr(datetime('now'), 'yyyymmdd_HHMMSS'),'_a=',num2str(a), '_b=', num2str(b), '_growth=', num2str(growthrate) );
