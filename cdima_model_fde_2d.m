...
prefix = strcat('cdima_2d_noisy_square_wavyinit_' , datestr(datetime('now'), 'yyyymmdd_HHMMSS'), '_b=', num2str(b), '_growth=', num2str(growthrate) );
